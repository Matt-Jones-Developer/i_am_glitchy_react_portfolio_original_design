...
//         </div>
//       </div>
//       <div className="project-grid project-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
//         {projects.map((project, i) => {
//           return (
//             <>
//               <div className="projects w-full h-auto" key={i}>
...
//                   <h3>{project.desc}</h3>
//                   <button>{project.live}Live</button>
//                   <button>{project.code}Code</button>
//                 </div>
//               </div>
//             </>
//           )
